...
/**
 * The live OIDC gate (spec #57 / issue #62): the real round trip against the
 * development Keycloak — the sign-in page renders the Keycloak button (the
 * capability endpoint reports enabled), clicking it lands on the Keycloak
 * login page (the realm is in the URL), signing in lands on the app signed
 * in, and signing out then clicking again re-enters WITHOUT a password (user
 * story 9 — the Keycloak session outlives the local app session).
 *
